...
$html="<table style='width:100%; border-collapse: collapse; '>
                <tbody>
                    <tr><td colspan='8' style='font-size: 10; padding-top: 5px; padding-bottom: 5px; border-top: 1px solid #000000;border-bottom: 1px solid #000000; font-weight: bold;'>RESOLUTION []: CHANGE IN NAME OF THE COMPANY</td></tr>
                </tbody>
            </table>";
$docx->embedHTML($html);
...
$docx->embedHTML($html);
$html = "<p style='font-size: 10; text-align: justify; '>Current Name: </p>";
$html .= "<p style='font-size: 10; text-align: justify; '>Proposed Name: </p>";
$html .= "<p style='font-size: 10; text-align: justify; '>Availability of the proposed name:  </p>";
$docx->embedHTML($html);
